...
/**
 * Servlet implementation class RegistryAPI
 */
@WebServlet("/RegistryAPI")
public class RegistryAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = regObj.insertItem(request.getParameter("firstName"), 
